...
__all__ = ['SimAM', 'SpatialGroupEnhance', 'BiLevelRoutingAttention', 'BiLevelRoutingAttention_nchw', 'TripletAttention',
           'CoordAtt', 'BAMBlock', 'EfficientAttention', 'LSKBlock', 'SEAttention', 'CPCA', 'CoA', 'deformable_LKA',
...
class CoA(nn.Module):
    ...
    def forward(self, x):
        ...
        return x * x_pool_h.sigmoid() * x_pool_w.permute(0, 1, 3, 2).sigmoid() + x * x_pool_ch.sigmoid()
