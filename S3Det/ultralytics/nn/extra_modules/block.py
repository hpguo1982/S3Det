...
__all__ = ['DyHeadBlock', 'DyHeadBlockWithDCNV3', 'Fusion', 'C2f_Faster', 'C3_Faster', 'C3_ODConv', 'C2f_ODConv', 'Partial_conv3', 'C2f_Faster_EMA', 'C3_Faster_EMA', 'C2f_DBB',
           ...
           'C3_OREPA', 'C2f_OREPA', 'C3_DBB', 'C3_REPVGGOREPA', 'C2f_REPVGGOREPA', 'C3_DCNv2_Dynamic', 'EDC',
           ...
           'C2f_AggregatedAtt', 'C3_AggregatedAtt', 'SDI', 'DCNV4_YOLO', 'C3_DCNv4', 'C2f_DCNv4', 'DyHeadBlockWithDCNV4', 'ChannelAttention_DCLP', 'Multiply', 'DySample', 'CARAFE', 'HWD',
...
class DCNv2_Offset_Attention(nn.Module):
    def __init__(self, in_channels, kernel_size, stride, deformable_groups=1) -> None:
        ...
        self.attention = CoA(self.out_channel)
        # self.attention = CoordAtt(self.out_channel)
        # self.attention = SEAttention(self.out_channel)
        # self.attention = TripletAttention(self.out_channel)
    ...
    def forward(self, x):
        ...
        # 修改
        conv_offset_mask = self.attention(self.conv_offset_mask(x))
...
class ChannelAttention_DCLP(nn.Module):
    def __init__(self, in_planes, ratio = 4, flag=True):
        super(ChannelAttention_DCLP, self).__init__()
        self.avg_pool = nn.AdaptiveAvgPool2d(1)
